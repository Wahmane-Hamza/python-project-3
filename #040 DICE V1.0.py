...
def turn_of_who(t,t2):
    ...
    if turnWho == 0:
        red_turn.place(x=1277, y=35)
    elif turnWho == 1:
        blue_turn.place(x=1277, y=35)
    elif turnWho == 2:
        green_turn.place(x=1277, y=35)
    else:
        yellow_turn.place(x=1277, y=35)
...
def move_position(dice_random_number,myButton):
    ...
    if turn == 3:
        if yellow_x_y == 'done':
            ...
            # if u call funtion from inside of it again she will contune and play again if you didn't add return after it 
            return
